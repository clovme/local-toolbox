...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.rolePermissionDo.UseModel(&auth.RolePermission{})
...
func (r rolePermissionDo) Create(values ...*auth.RolePermission) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rolePermissionDo) CreateInBatches(values []*auth.RolePermission, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r rolePermissionDo) Save(values ...*auth.RolePermission) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rolePermissionDo) First() (*auth.RolePermission, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*auth.RolePermission), nil
	}
}

func (r rolePermissionDo) Take() (*auth.RolePermission, error) {
...
func (r rolePermissionDo) Last() (*auth.RolePermission, error) {
...
func (r rolePermissionDo) Find() ([]*auth.RolePermission, error) {
	result, err := r.DO.Find()
	return result.([]*auth.RolePermission), err
}

func (r rolePermissionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*auth.RolePermission, err error) {
	buf := make([]*auth.RolePermission, 0, batchSize)
...
func (r rolePermissionDo) FindInBatches(result *[]*auth.RolePermission, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r rolePermissionDo) FirstOrInit() (*auth.RolePermission, error) {
...
func (r rolePermissionDo) FirstOrCreate() (*auth.RolePermission, error) {
...
func (r rolePermissionDo) FindByPage(offset int, limit int) (result []*auth.RolePermission, count int64, err error) {
...
func (r rolePermissionDo) Delete(models ...*auth.RolePermission) (result gen.ResultInfo, err error) {
