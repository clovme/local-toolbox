...
func newToken(db *gorm.DB, opts ...gen.DOOption) token {
	...
	_token.tokenDo.UseModel(&models.Token{})
...
func (t tokenDo) Create(values ...*models.Token) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tokenDo) CreateInBatches(values []*models.Token, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t tokenDo) Save(values ...*models.Token) error {
	if len(values) == 0 {
		return nil
	}
...
func (t tokenDo) First() (*models.Token, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.Token), nil
	}
}

func (t tokenDo) Take() (*models.Token, error) {
...
func (t tokenDo) Last() (*models.Token, error) {
...
func (t tokenDo) Find() ([]*models.Token, error) {
	result, err := t.DO.Find()
	return result.([]*models.Token), err
}

func (t tokenDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.Token, err error) {
	buf := make([]*models.Token, 0, batchSize)
...
func (t tokenDo) FindInBatches(result *[]*models.Token, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t tokenDo) FirstOrInit() (*models.Token, error) {
...
func (t tokenDo) FirstOrCreate() (*models.Token, error) {
...
func (t tokenDo) FindByPage(offset int, limit int) (result []*models.Token, count int64, err error) {
...
func (t tokenDo) Delete(models ...*models.Token) (result gen.ResultInfo, err error) {
