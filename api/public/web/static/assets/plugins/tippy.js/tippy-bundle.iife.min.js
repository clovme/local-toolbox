var tippy = function (t) {
    ...
    var V = "undefined" != typeof window && "undefined" != typeof document, B = V ? navigator.userAgent : "", H = /MSIE |Trident\//.test(B), U = V && /iPhone|iPad|iPod/.test(navigator.platform);
    ...
    var z = e({
        allowHTML: !0, animation: "fade", appendTo: function () {
            return document.body
        }, aria: "describedby", arrow: !0, boundary: "scrollParent", content: "", delay: 0, distance: 10, duration: [300, 250], flip: !0, flipBehavior: "flip", flipOnUpdate: !1, hideOnClick: !0, ignoreAttributes: !1, inertia: !1, interactive: !1, interactiveBorder: 2, interactiveDebounce: 0, lazy: !0, maxWidth: 350, multiple: !1, offset: 0, onAfterUpdate: function () {
        ...
        }, placement: "top", plugins: [], popperOptions: {}, role: "tooltip", showOnCreate: !1, theme: "", touch: !0, trigger: "mouseenter focus", triggerTarget: null, updateDuration: 0, zIndex: 9999
    }, {animateFill: !1, followCursor: !1, inlinePositioning: !1, sticky: !1}), R = Object.keys(z), q = ["arrow", "boundary", "distance", "flip", "flipBehavior", "flipOnUpdate", "offset", "placement", "popperOptions"];
    ...
    function j(t, n) {
        var r = e({}, n, {content: f(n.content, [t])}, n.ignoreAttributes ? {} : function (t, n) {
            return (n ? Object.keys(F(e({}, z, {plugins: n}))) : R).reduce((function (e, n) {
    ...
    function J(t) {
        return {tooltip: t.querySelector(".tippy-tooltip"), content: t.querySelector(".tippy-content"), arrow: t.querySelector(".tippy-arrow") || t.querySelector(".tippy-svg-arrow")}
    }
    ...
    function Q(t, e, n) {
        var r, i = J(t), o = i.tooltip, a = i.content, p = i.arrow;
    ...
    function rt(r, i) {
        var a, s, c, v = j(r, e({}, z, {}, F(i)));
        if (!v.multiple && r._tippy) return null;
        var k, M, S, P, V, B = !1, U = !1, R = !1, W = 0, X = [], Y = h(Dt, v.interactiveDebounce), G = C(v.triggerTarget || r), $ = tt++, rt = K($, v), it = J(rt), ot = (V = v.plugins).filter((function (t, e) {
            return V.indexOf(t) === e
        })), at = it.tooltip, pt = it.content, ut = [at, pt], st = {
            id: $, reference: r, popper: rt, popperChildren: it, popperInstance: null, props: v, state: {currentPlacement: null, isEnabled: !0, isVisible: !1, isDestroyed: !1, isMounted: !1, isShown: !1}, plugins: ot, clearDelayTimeouts: function () {
                clearTimeout(a), clearTimeout(s), cancelAnimationFrame(c)
            }, setProps: function (t) {
                if (st.state.isDestroyed) return;
                gt("onBeforeUpdate", [st, t]), It();
                var n = st.props, i = j(r, e({}, st.props, {}, t, {ignoreAttributes: !0}));
                ...
                var e = st.state.isVisible, n = st.state.isDestroyed, r = !st.state.isEnabled, i = L.isTouch && !st.props.touch;
                if (e || n || r || i) return;
                ...
                M = function () {
                    ...
                    W = 0;
                    var t, e = st.props.appendTo, n = vt();
                ...
                var e = !st.state.isVisible && !B, n = st.state.isDestroyed, r = !st.state.isEnabled && !B;
                if (e || n || r) return;
        ...
        function xt(t, e, n) {
            void 0 === n && (n = !1), x(st.props.triggerTarget || r).forEach((function (r) {
                r.addEventListener(t, e, n), X.push({node: r, eventType: t, handler: e, options: n})
            }))
        }
        ...
        function Dt(t) {
            ...
            "mousemove" === t.type && e || function (t, e) {
                ...
                return t.every((function (t) {
                    var e = t.popperRect, i = t.tooltipRect, o = t.interactiveBorder, a = Math.min(e.top, i.top), p = Math.max(e.right, i.right), u = Math.max(e.bottom, i.bottom), s = Math.min(e.left, i.left);
                ...
                return {popperRect: t.getBoundingClientRect(), tooltipRect: n.getBoundingClientRect(), interactiveBorder: r}
            })), t) && (yt(), Bt(t))
        }
        ...
        function Mt(t) {
            var e = "ontouchstart" in window, n = E(t.type, "touch"), r = dt();
            return e && L.isTouch && r && !n || L.isTouch && !r && n
        }

        function St() {
            var n, i = st.props.popperOptions, o = st.popperChildren.arrow, a = u(i, "flip"), p = u(i, "preventOverflow");
            ...
            function s(t) {
                ...
                var r = _(t.placement), i = E(["top", "bottom"], r), o = E(["bottom", "right"], r);
                ...
                modifiers: e({}, i && i.modifiers, {
                    tippyDistance: {
                        enabled: !0, order: 0, fn: function (t) {
                            n = function (t, e) {
                                var n = "string" == typeof e && E(e, "rem"), r = t.documentElement;
                                return r && n ? parseFloat(getComputedStyle(r).fontSize || String(16)) * O(e) : O(e)
                            }(G, st.props.distance);
                            var e = _(t.placement), r = D(e, p && p.padding, n), i = D(e, a && a.padding, n), o = st.popperInstance.modifiers;
                            return d(o, "preventOverflow", "padding", r), d(o, "flip", "padding", i), t
                        }
                    }, preventOverflow: e({boundariesElement: st.props.boundary}, p), flip: e({enabled: st.props.flip, behavior: st.props.flipBehavior}, a), arrow: e({element: o, enabled: !!o}, u(i, "arrow")), offset: e({offset: st.props.offset}, u(i, "offset"))
                }), onCreate: function (t) {
    ...
    function it(t, r, i) {
        void 0 === r && (r = {}), void 0 === i && (i = []), i = z.plugins.concat(r.plugins || i), document.addEventListener("touchstart", M, e({}, n, {capture: !0})), window.addEventListener("blur", P);
        var o = e({}, r, {plugins: i}), p = a(t).reduce((function (t, e) {
            var n = e && rt(e, o);
            return n && t.push(n), t
        }), []);
        return c(t) ? p[0] : p
    ...
    var at = {
        name: "animateFill", defaultValue: !1, fn: function (t) {
            var e = t.popperChildren, n = e.tooltip, r = e.content, i = t.props.animateFill ? function () {
                var t = v();
            ...
            return {
                onCreate: function () {
                    i && (o(), n.insertBefore(i, n.firstElementChild), n.setAttribute("data-animatefill", ""), n.style.overflow = "hidden", t.setProps({animation: "shift-away", arrow: !1}))
                }, onMount: function () {
                    if (i) {
    ...
    var pt = {
        name: "followCursor", defaultValue: !1, fn: function (t) {
            var e, n = t.reference, r = t.popper, i = null, o = C(t.props.triggerTarget || n), a = null, p = !1, u = t.props;
            ...
            function y(o) {
                ...
                if (t.popperInstance && t.state.currentPlacement) {
                    var s = w(o.target, (function (t) {
                        return t === n
                    })), c = t.props.followCursor, l = "horizontal" === c, d = "vertical" === c, v = E(["top", "bottom"], _(t.state.currentPlacement)), m = function (t, e) {
                        var n = e ? t.offsetWidth : t.offsetHeight;
                        return {size: n, x: e ? n : 0, y: e ? 0 : n}
                    }(r, v), g = m.size, h = m.x, y = m.y;
                    !s && t.props.interactive || (null === i && (i = t.popperInstance.reference), t.popperInstance.reference = {
                        referenceNode: n, clientWidth: 0, clientHeight: 0, getBoundingClientRect: function () {
                            var t = n.getBoundingClientRect();
                            return {width: v ? g : 0, height: v ? 0 : g, top: (l ? t.top : u) - y, bottom: (l ? t.bottom : u) + y, left: (d ? t.left : p) - h, right: (d ? t.right : p) + h}
                        }
            ...
            return {
                onAfterUpdate: function (t, e) {
                    ...
                    a || (l(n) && (a = {clientX: n.clientX, clientY: n.clientY}, e = n), v(), g())
                }, onUntrigger: function () {
            ...
            return {
                onHidden: function () {
                    ...
                    n() && (t.popperInstance.reference = {
                        referenceNode: e, clientWidth: 0, clientHeight: 0, getBoundingClientRect: function () {
                            return function (t, e, n) {
                                if (n.length < 2 || null === t) return e;
                                switch (t) {
                                    case"top":
                                    case"bottom":
                                        var r = n[0], i = n[n.length - 1], o = "top" === t, a = r.top, p = i.bottom, u = o ? r.left : i.left, s = o ? r.right : i.right;
    ...
    var st = {
        name: "sticky", defaultValue: !1, fn: function (t) {
            ...
            function a() {
                var p = r("reference") ? (t.popperInstance ? t.popperInstance.reference : e).getBoundingClientRect() : null, u = r("popper") ? n.getBoundingClientRect() : null;
    ...
    return V && function (t) {
        ...
        return it(v(), e({}, n, {plugins: [s].concat(r), aria: null, triggerTarget: u}))
    }, it.delegate = function (t, n, r) {
        void 0 === r && (r = []), r = n.plugins || r;
        var i, o, a = [], p = [], u = n.target, s = (i = ["target"], o = e({}, n), i.forEach((function (t) {
            delete o[t]
        })), o), c = e({}, s, {plugins: r, trigger: "manual"}), l = e({}, s, {plugins: r, showOnCreate: !0}), f = it(t, c);
        ...
        function v(t, e, n, r) {
            void 0 === r && (r = !1), t.addEventListener(e, n, r), a.push({node: t, eventType: e, handler: n, options: r})
        }
